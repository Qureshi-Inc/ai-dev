...
export function implementPrompt(args: {
  ...
  const system = [
    ...
    "Output the COMPLETE new contents of every file you change. Never produce diffs or partial files.",
    "",
    ...
    "@@FILE <repo-relative-path> <create|modify|delete>",
    "<the full raw file content goes here, starting on this line>",
    "@@END",
    "",
    "Repeat the @@FILE ... @@END block once per changed file.",
    "Rules:",
    "- The file content is raw text between the @@FILE header line and the @@END line. Do NOT escape it.",
    "- For a delete action, put no content between the header and @@END.",
    "- Never emit the tokens @@FILE or @@END inside file content.",
